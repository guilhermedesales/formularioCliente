...
function showReviewModal() {
    ...
    html += buildReviewItem('Telefone', formData.get('Telefone'));
    html += buildReviewItem('Convênio', formData.get('Convênio'));
    html += buildReviewItem('Ginecologista', formData.get('médico'));
    html += '</div>';
    
    // Section 2: Informações Médicas
    html += '<div class="review-section">';
    html += '<h3>💙 Informações Médicas</h3>';
    html += buildReviewItem('Última Menstruação', formData.get('Última Menstruação'));
    ...
    // Section 4: Outras Informações de Saúde
    html += '<div class="review-section">';
    html += '<h3>🏥 Outras Informações de Saúde</h3>';
    html += buildReviewItem('Doenças', formData.get('Doença') || 'Nenhuma');
    html += buildReviewItem('Doenças na Família', formData.get('DoençaFamilia') || 'Nenhuma');
    html += buildReviewItem('Medicações em Uso', formData.get('Medicação') || 'Nenhuma');
    html += '</div>';
